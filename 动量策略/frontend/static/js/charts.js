...
function initModalKlineChart() {
    const container = document.getElementById('modalKlineChart');
    if (container && !modalKlineChart) {
        modalKlineChart = echarts.init(container);
    }
}
...
function updateModalKlineChart(data) {
    initModalKlineChart();
    ...
    modalKlineChart.setOption(option);
    setTimeout(() => modalKlineChart.resize(), 100);
}
